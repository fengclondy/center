...
public interface HTDHeadAdvertiseDAO extends BaseDAO<HTDHeadAdvertiseDAO>{
	 ...
	 * @return
	 */
	public List<HTDAdvertisementDTO> queryHeadAdvertisement(@Param("page")Pager page, @Param("dto")HTDAdvertisementDTO dto);
