...
public class ItemAttrDTO implements Serializable {
	...
	private Long id;
	private String name;
	private Integer status;// 属性状态 0 删除 1有效
	...
	private List<ItemAttrValueDTO> values;
	...
	public List<ItemAttrValueDTO> getValues() {
		return values;
	}

	public void setValues(List<ItemAttrValueDTO> values) {
		this.values = values;
	}
