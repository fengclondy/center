...
public class ItemSkuPublishInfoUtil {
    ...
    public static void doUpdateItemSkuPublishInfo(Long operatorId, String operatorName, ItemSku itemSku, Integer stockNum, ItemSkuPublishInfo itemSkuPublishInfo) {
