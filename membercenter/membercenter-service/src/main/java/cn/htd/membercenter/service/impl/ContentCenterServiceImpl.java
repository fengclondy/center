...
import cn.htd.membercenter.dao.ContentCenterDAO;
import cn.htd.membercenter.dao.MemberBaseOperationDAO;
import cn.htd.membercenter.dto.MemberBaseInfoDTO;
import cn.htd.membercenter.service.ContentCenterService;
...
public class ContentCenterServiceImpl implements ContentCenterService {
	private final static Logger logger = LoggerFactory
			.getLogger(ContentCenterServiceImpl.class);
	@Resource
				...
				if (list != null && size > 0) {
					...
					for (int i = 0; i < sort; i++) {
						...
						if (result.getResult() != null) {
							...
							MemberExtendInfo memberExtendInfo = memberBaseOperationDAO
