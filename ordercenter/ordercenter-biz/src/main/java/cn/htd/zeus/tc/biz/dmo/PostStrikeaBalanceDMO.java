...
public class PostStrikeaBalanceDMO extends GenericDMO{

	/**
	 *
	 */
	private static final long serialVersionUID = 2153113906081265193L;
	 ...
	 * 二级节点
	 */
	private List<CollectPaymentInfoDMO> detail;
	...
	public List<CollectPaymentInfoDMO> getDetail() {
		return detail;
	}

	public void setDetail(List<CollectPaymentInfoDMO> detail) {
		this.detail = detail;
	}
