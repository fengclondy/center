...
public class TradeOrderItemsDMO extends GenericDMO{

	/**
	 *
	 */
	private static final long serialVersionUID = -5962185303672444812L;
    ...
    private String orderItemNos;//用逗号分隔的订单行
