...
public class TradeOrdersDMO extends GenericDMO {
	/**
	 *
	 */
	private static final long serialVersionUID = -188964460664898430L;
	private Long id;
	...
	public Integer getIsVipMember() {
		return isVipMember;
	}

	public void setIsVipMember(Integer isVipMember) {
	...
	public void setOrderItemsList(List<TradeOrderItemsDMO> orderItemsList) {
	...
	public List<TradeOrderStatusHistoryDMO> getOrderTail() {
		return orderTail;
	}

	public void setOrderTail(List<TradeOrderStatusHistoryDMO> orderTail) {
