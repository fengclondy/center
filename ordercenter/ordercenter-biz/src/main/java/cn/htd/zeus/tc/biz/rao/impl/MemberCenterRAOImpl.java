...
public class MemberCenterRAOImpl implements MemberCenterRAO {
	...
	private static final Logger LOGGER = LoggerFactory
			.getLogger(MemberCenterRAOImpl.class);

	/*
	 * 根据会员code和type查询会员信息
	 */
	@Override
	public OtherCenterResDTO<MemberBaseInfoDTO> selectMemberBaseName(
			String memberCode, String buyerSellerType, String messageId) {
		OtherCenterResDTO<MemberBaseInfoDTO> otherCenterResDTO = new OtherCenterResDTO<MemberBaseInfoDTO>();
		try {
			Long startTime = System.currentTimeMillis();
			LOGGER.info("查询会员中心(selectMemberBaseName查询会员详情信息)--组装查询参数开始:"
					+ "MessageId:" + messageId + " memberCode:" + memberCode
			...
			LOGGER.info(
					"MessageId:{}查询会员中心(selectMemberBaseName查询会员详情信息)--返回结果:{}",
					messageId, JSONObject.toJSONString(memberExecuteResult)
							+ " 耗时:" + (endTime - startTime));
			if (memberExecuteResult.getCode().equals(
					ResultCodeEnum.SUCCESS.getCode())) {
				MemberBaseInfoDTO memberBaseInfoDTO = memberExecuteResult
						.getResult();
				otherCenterResDTO.setOtherCenterResult(memberBaseInfoDTO);
				otherCenterResDTO
						.setOtherCenterResponseCode(ResultCodeEnum.SUCCESS
								.getCode());
			} else {
				// 没有查到数据
				LOGGER.warn(
						"MessageId:{} 从会员中心-(selectMemberBaseName查询会员详情信息)-没有查到数据 返回错误码和错误信息:{}",
						messageId, memberExecuteResult.getCode()
								+ memberExecuteResult.getResultMessage());
				otherCenterResDTO
						.setOtherCenterResponseMsg(FacadeOtherResultCodeEnum.MEMBERCENTER_QUERY_NOT_RESULT
								.getMsg());
				otherCenterResDTO
						.setOtherCenterResponseCode(FacadeOtherResultCodeEnum.MEMBERCENTER_QUERY_NOT_RESULT
								.getCode());
			}
		} catch (Exception e) {
			...
			LOGGER.error(
					"MessageId:{} 调用方法MemberCenterRAOImpl.selectMemberBaseName出现异常{}",
	 ...
	 */
	public OtherCenterResDTO<MemberGroupDTO> selectBuyCodeSellCode(
			String sellerCode, String buyerCode, String messageId) {
		OtherCenterResDTO<MemberGroupDTO> otherCenterResDTO = new OtherCenterResDTO<MemberGroupDTO>();
		try {
			Long startTime = System.currentTimeMillis();
			LOGGER.info("查询会员中心(selectBuyCodeSellCode查询会员分组id和买家等级信息)--组装查询参数开始:"
					+ "MessageId:"
					+ messageId
					+ " sellerCode:"
					+ sellerCode
			...
			Long endTime = System.currentTimeMillis();
			LOGGER.info(
					"MessageId:{}查询会员中心(selectBuyCodeSellCode查询会员分组id和买家等级信息)--返回结果:{}",
					messageId, JSONObject.toJSONString(memberGroupResDTO)
							+ " 耗时:" + (endTime - startTime));
			if (memberGroupResDTO.getCode().equals(
					ResultCodeEnum.SUCCESS.getCode())) {
				...
				LOGGER.warn(
						...
						messageId, memberGroupResDTO.getCode()
								+ memberGroupResDTO.getResultMessage());
				otherCenterResDTO
						.setOtherCenterResponseMsg(FacadeOtherResultCodeEnum.MEMBERCENTER_QUERY_BUYERGRADE_AND_MEMBERGROUPID_NOT_RESULT
								.getMsg());
				otherCenterResDTO
						.setOtherCenterResponseCode(FacadeOtherResultCodeEnum.MEMBERCENTER_QUERY_BUYERGRADE_AND_MEMBERGROUPID_NOT_RESULT
								.getCode());
			}
		} catch (Exception e) {
			StringWriter w = new StringWriter();
			e.printStackTrace(new PrintWriter(w));
			LOGGER.error(
					"MessageId:{} 调用方法MemberCenterRAOImpl.selectBuyCodeSellCode出现异常{}",
					messageId, w.toString());
			otherCenterResDTO.setOtherCenterResponseMsg(ResultCodeEnum.ERROR
					.getMsg());
			otherCenterResDTO.setOtherCenterResponseCode(ResultCodeEnum.ERROR
	 ...
	 * @return
	 */
	public OtherCenterResDTO<MemberGradeDTO> queryMemberGradeInfo(
			String memberCode, String messageId) {
		...
		try {
			...
			Long endTime = System.currentTimeMillis();
			LOGGER.info("MessageId:{} 订单结算--查询会员等级信息 耗时:{}", messageId, endTime
					- startTime);
			MemberGradeDTO gradeDTO = gradeResult.getResult();
			if (gradeDTO != null
					&& "success".equals(gradeResult.getResultMessage())) {
				other.setOtherCenterResult(gradeDTO);
				other.setOtherCenterResponseCode(ResultCodeEnum.SUCCESS
						.getCode());
				other.setOtherCenterResponseMsg(ResultCodeEnum.SUCCESS.getMsg());
			} else {
				LOGGER.warn(
						"MessageId:{} 订单结算--查询会员等级(queryMemberGradeInfo查询会员等级信息)-没有查到数据 参数:{}",
			...
			e.printStackTrace(new PrintWriter(w));
			LOGGER.error(
					"MessageId:{} 调用方法MemberCenterRAOImpl.queryMemberGradeInfo出现异常{}",
					messageId, w.toString());
			other.setOtherCenterResponseMsg(ResultCodeEnum.ERROR.getMsg());
			other.setOtherCenterResponseCode(ResultCodeEnum.ERROR.getCode());
		}
	 ...
	 * @return
	 */
	public OtherCenterResDTO<List<MemberConsigAddressDTO>> queryConsigAddressList(
			String memberCode, String messageId) {
		...
		try {
			...
			Long endTime = System.currentTimeMillis();
			LOGGER.info("MessageId:{} 订单结算--查询会员收货信息 耗时:{}", messageId, endTime
					- startTime);
			...
			e.printStackTrace(new PrintWriter(w));
			LOGGER.error(
					"MessageId:{} 调用方法MemberCenterRAOImpl.queryConsigAddressList出现异常{}",
					messageId, w.toString());
			other.setOtherCenterResponseMsg(ResultCodeEnum.ERROR.getMsg());
			other.setOtherCenterResponseCode(ResultCodeEnum.ERROR.getCode());
		}
	 ...
	 * @return
	 */
	public OtherCenterResDTO<MemberInvoiceDTO> queryMemberInvoiceInfo(
			String memberCode, String channelCode, String messageId) {
		OtherCenterResDTO<MemberInvoiceDTO> other = new OtherCenterResDTO<MemberInvoiceDTO>();
		try {
			Long startTime = System.currentTimeMillis();
			LOGGER.info("查询会员发票信息--组装查询参数开始:" + "MessageId:" + messageId
					+ " memberCode:" + memberCode + " channelCode:"
					+ channelCode);
			...
			Long endTime = System.currentTimeMillis();
			LOGGER.info("MessageId:{}查询会员发票信息 耗时:{}", messageId, endTime
					- startTime);
			MemberInvoiceDTO invoiceInfo = result.getResult();
			if (invoiceInfo != null
					&& result.getResultMessage().equals("success")) {
			...
			e.printStackTrace(new PrintWriter(w));
			LOGGER.error(
					"MessageId:{} 调用方法MemberCenterRAOImpl.queryMemberInvoiceInfo出现异常{}",
					messageId, w.toString());
			other.setOtherCenterResponseMsg(ResultCodeEnum.ERROR.getMsg());
			other.setOtherCenterResponseCode(ResultCodeEnum.ERROR.getCode());
		}
	...
	@Override
	public OtherCenterResDTO<String> queryMemberCodeByMemberId(long memberId,
			String messageId) {
		...
		try {
			...
			LOGGER.info("MessageId:{} 订单结算--查询会员编码信息--返回结果:{}", messageId,
					memberId);
			Long endTime = System.currentTimeMillis();
			LOGGER.info("MessageId:{} 订单结算--查询会员编码信息 耗时:{}", messageId, endTime
					- startTime);
			...
			e.printStackTrace(new PrintWriter(w));
			LOGGER.error(
					"MessageId:{} 调用方法MemberCenterRAOImpl.queryMemberCodeByMemberId出现异常{}",
					messageId, w.toString());
			other.setOtherCenterResponseMsg(ResultCodeEnum.ERROR.getMsg());
			other.setOtherCenterResponseCode(ResultCodeEnum.ERROR.getCode());
		}
	...
	@Override
	public OtherCenterResDTO<MemberBaseInfoDTO> getMemberDetailBySellerId(
			long memberId, String messageId) {
		...
		try {
			...
			Long endTime = System.currentTimeMillis();
			LOGGER.info("MessageId:{} 查询会员信息 耗时:{}", messageId, endTime
					- startTime);
			MemberDetailInfo memberInfo = memberDetail.getResult();
			if (memberInfo != null && memberInfo.getMemberBaseInfoDTO() != null) {
				other.setOtherCenterResult(memberInfo.getMemberBaseInfoDTO());
			...
			e.printStackTrace(new PrintWriter(w));
			LOGGER.error(
					"MessageId:{} 调用方法MemberCenterRAOImpl.queryMemberCodeByMemberInfo出现异常{}",
					messageId, w.toString());
			other.setOtherCenterResponseMsg(ResultCodeEnum.ERROR.getMsg());
			other.setOtherCenterResponseCode(ResultCodeEnum.ERROR.getCode());
		}
	 ...
	 */
	public OtherCenterResDTO<String> selectChannelAddressDTO(String messageId,
			String memberCode, String channelCode) {
		OtherCenterResDTO<String> other = new OtherCenterResDTO<String>();
		try {
			Long startTime = System.currentTimeMillis();
			LOGGER.info("查询卖家的地址--组装查询参数开始:" + "MessageId:" + messageId
					+ "memberCode:" + memberCode + "channelCode:" + channelCode);
			...
			if (null != result.getResult() && result.isSuccess() == true) {
				...
				String area = province + "_" + city + "_" + district + "_"
						+ town;
				...
				// 没有查到数据
				LOGGER.warn(
						"MessageId:{}查询卖家的地址(selectChannelAddressDTO)-没有查到数据 参数:{}",
						messageId);
				other.setOtherCenterResponseCode(FacadeOtherResultCodeEnum.MEMBERCENTER_QUERY_NOT_JD_ADRESS
						.getCode());
				other.setOtherCenterResponseMsg(FacadeOtherResultCodeEnum.MEMBERCENTER_QUERY_NOT_JD_ADRESS
						.getMsg());
			}
		} catch (Exception e) {
			StringWriter w = new StringWriter();
			e.printStackTrace(new PrintWriter(w));
			LOGGER.error(
					"MessageId:{} 调用方法MemberCenterRAOImpl.selectChannelAddressDTO出现异常{}",
					messageId, w.toString());
			other.setOtherCenterResponseMsg(ResultCodeEnum.ERROR.getMsg());
			other.setOtherCenterResponseCode(ResultCodeEnum.ERROR.getCode());
		}
	...
	public OtherCenterResDTO<MemberConsigAddressDTO> selectChannelAddressDTO4Common(
		...
		try {
			Long startTime = System.currentTimeMillis();
			LOGGER.info("查询卖家的地址--4common--组装查询参数开始:" + "MessageId:"
					+ messageId + "memberCode:" + memberCode + "channelCode:"
					+ channelCode);
			ExecuteResult<MemberConsigAddressDTO> result = consigneeAddressService
					.selectChannelAddressDTO(messageId, memberCode, channelCode);
			LOGGER.info(
					"MessageId:{} 查询卖家的地址--4common--返回结果:{}",
					messageId,
					JSONObject.toJSONString(result) + "耗时:"
							+ (System.currentTimeMillis() - startTime));
			if (null != result.getResult() && result.isSuccess() == true) {
				...
				// 没有查到数据
				LOGGER.warn(
						"MessageId:{}查询卖家的地址(selectChannelAddressDTO4Common)-没有查到数据 参数:{}",
						messageId);
				other.setOtherCenterResponseCode(FacadeOtherResultCodeEnum.MEMBERCENTER_QUERY_NOT_RESULT
						.getCode());
				other.setOtherCenterResponseMsg(FacadeOtherResultCodeEnum.MEMBERCENTER_QUERY_NOT_RESULT
						.getMsg());
			}
		} catch (Exception e) {
			StringWriter w = new StringWriter();
	 ...
	 */
	@Override
	public OtherCenterResDTO<Long> getMemberIdByCode(String memberCode,
			String messageId) {
		OtherCenterResDTO<Long> other = new OtherCenterResDTO<Long>();
		try {
			Long startTime = System.currentTimeMillis();
			LOGGER.info("查询会员code--组装查询参数开始:" + "MessageId:" + messageId
					+ "memberCode:" + memberCode);
			ExecuteResult<Long> result = memberBaseInfoService
					.getMemberIdByCode(memberCode);
			LOGGER.info(
					"MessageId:{} 查询会员code--返回结果:{}",
					messageId,
					JSONObject.toJSONString(result) + "耗时:"
							+ (System.currentTimeMillis() - startTime));
			if (null != result.getResult() && result.isSuccess() == true) {
				...
				// 没有查到数据
				LOGGER.warn(
						"MessageId:{}根据code查询会员的id(getMemberIdByCode)-没有查到数据 参数:{}",
			...
			e.printStackTrace(new PrintWriter(w));
			LOGGER.error(
					"MessageId:{} 调用方法MemberCenterRAOImpl.getMemberIdByCode出现异常{}",
					messageId, w.toString());
			other.setOtherCenterResponseMsg(ResultCodeEnum.ERROR.getMsg());
			other.setOtherCenterResponseCode(ResultCodeEnum.ERROR.getCode());
		}
	...
	public OtherCenterResDTO<MemberDetailInfo> getMemberDetailById(
		...
		try {
			...
			if (null != result.getResult() && result.isSuccess() == true) {
				...
				// 没有查到数据
				LOGGER.warn(
						"MessageId:{}查询注册地址(getMemberDetailById)-没有查到数据 参数:{}",
						messageId, memberId);
				other.setOtherCenterResponseCode(FacadeOtherResultCodeEnum.MEMBERCENTER_QUERY_NOT_RESULT
						.getCode());
				other.setOtherCenterResponseMsg(FacadeOtherResultCodeEnum.MEMBERCENTER_QUERY_NOT_RESULT
			...
			e.printStackTrace(new PrintWriter(w));
			LOGGER.error(
					"MessageId:{} 调用方法MemberCenterRAOImpl.getMemberDetailById出现异常{}",
					messageId, w.toString());
			other.setOtherCenterResponseMsg(ResultCodeEnum.ERROR.getMsg());
			other.setOtherCenterResponseCode(ResultCodeEnum.ERROR.getCode());
		}
	 ...
	 */
	@Override
	public OtherCenterResDTO<MemberBuyerGradeInfoDTO> queryBuyerGradeInfo(
			Long memberId, String messageId) {
		OtherCenterResDTO<MemberBuyerGradeInfoDTO> other = new OtherCenterResDTO<MemberBuyerGradeInfoDTO>();
		try {
			Long startTime = System.currentTimeMillis();
			LOGGER.info("MessageId{}查询会员等级详细信息--组装查询参数开始:MemberId{}",
					messageId, memberId);
			ExecuteResult<MemberBuyerGradeInfoDTO> result = memberBuyerService
					.queryBuyerGradeInfo(memberId);
			LOGGER.info(
					"MessageId:{} 查询会员等级详细信息--返回结果:{}",
					messageId,
					JSONObject.toJSONString(result) + "耗时:"
							+ (System.currentTimeMillis() - startTime));
			if (null != result.getResult() && result.isSuccess() == true) {
				MemberBuyerGradeInfoDTO memberBuyerGradeInfo = result
						.getResult();
				...
				// 没有查到数据
				LOGGER.warn(
						"MessageId:{}查询会员等级详细信息(queryBuyerGradeInfo)-没有查到数据 参数:{}",
						messageId, memberId);
				other.setOtherCenterResponseCode(FacadeOtherResultCodeEnum.MEMBERCENTER_QUERY_NOT_RESULT
						.getCode());
				other.setOtherCenterResponseMsg(FacadeOtherResultCodeEnum.MEMBERCENTER_QUERY_NOT_RESULT
			...
			e.printStackTrace(new PrintWriter(w));
			LOGGER.error(
					"MessageId:{} 调用方法MemberCenterRAOImpl.queryBuyerGradeInfo出现异常{}",
					messageId, w.toString());
			other.setOtherCenterResponseMsg(ResultCodeEnum.ERROR.getMsg());
			other.setOtherCenterResponseCode(ResultCodeEnum.ERROR.getCode());
		}
	 ...
	 * @return
	 */
	public OtherCenterResDTO<String> isHasInnerComapanyCert(String memberCode,
			String messageId) {

		OtherCenterResDTO<String> other = new OtherCenterResDTO<String>();
		try {
			Long startTime = System.currentTimeMillis();
			LOGGER.info("MessageId{}查询外部供应商是否有平台公司身份--组装查询参数开始:memberCode{}",
					messageId, memberCode);
			ExecuteResult<String> result = memberBaseInfoService
					.IsHasInnerComapanyCert(memberCode);
			;
			LOGGER.info(
					"MessageId:{} 查询外部供应商是否有平台公司身份--返回结果:{}",
					messageId,
					JSONObject.toJSONString(result) + "耗时:"
							+ (System.currentTimeMillis() - startTime));
			if (null != result.getResult() && result.isSuccess() == true) {
				...
				// 没有查到数据
				LOGGER.warn(
						"MessageId:{}查询外部供应商是否有平台公司身份(isHasInnerComapanyCert)-没有查到数据 参数:{}",
						messageId, memberCode);
				other.setOtherCenterResponseCode(FacadeOtherResultCodeEnum.MEMBERCENTER_QUERY_NOT_RESULT
						.getCode());
				other.setOtherCenterResponseMsg(FacadeOtherResultCodeEnum.MEMBERCENTER_QUERY_NOT_RESULT
			...
			e.printStackTrace(new PrintWriter(w));
			LOGGER.error(
					"MessageId:{} 调用方法MemberCenterRAOImpl.isHasInnerComapanyCert出现异常{}",
					messageId, w.toString());
			other.setOtherCenterResponseMsg(ResultCodeEnum.ERROR.getMsg());
			other.setOtherCenterResponseCode(ResultCodeEnum.ERROR.getCode());
		}
	...
	public OtherCenterResDTO<MemberBaseInfoDTO> getInnerInfoByOuterHTDCode(
			String memberCode, String messageId) {
		OtherCenterResDTO<MemberBaseInfoDTO> other = new OtherCenterResDTO<MemberBaseInfoDTO>();
		try {
			Long startTime = System.currentTimeMillis();
			LOGGER.info("MessageId{}查询外部供应商对应的平台公司code--组装查询参数开始:memberCode{}",
					messageId, memberCode);
			ExecuteResult<MemberBaseInfoDTO> result = memberBaseInfoService
					.getInnerInfoByOuterHTDCode(memberCode);
			LOGGER.info(
					"MessageId:{} 查询外部供应商对应的平台公司code--返回结果:{}",
					messageId,
					JSONObject.toJSONString(result) + "耗时:"
							+ (System.currentTimeMillis() - startTime));
			if (null != result.getResult() && result.isSuccess() == true) {
			...
			e.printStackTrace(new PrintWriter(w));
			LOGGER.error(
					"MessageId:{} 调用方法MemberCenterRAOImpl.getInnerInfoByOuterHTDCode出现异常{}",
					messageId, w.toString());
			other.setOtherCenterResponseMsg(ResultCodeEnum.ERROR.getMsg());
			other.setOtherCenterResponseCode(ResultCodeEnum.ERROR.getCode());
		}
	...
	@Override
	public OtherCenterResDTO<ApplyBusiRelationDTO> selectBusiRelation(
			Long memberId, Long sellerId, Long categoryId, Long brandId) {
		OtherCenterResDTO<ApplyBusiRelationDTO> other = new OtherCenterResDTO<ApplyBusiRelationDTO>();
		try {
			Long startTime = System.currentTimeMillis();
			LOGGER.info(
					"查询买家卖家经营关系--组装查询参数开始:memberId{}sellerId{}categoryId{}brandId{}",
			...
			LOGGER.info("查询买家卖家经营关系--返回结果:{}", JSONObject.toJSONString(result)
			...
			StringWriter w = new StringWriter();
			e.printStackTrace(new PrintWriter(w));
			LOGGER.error("调用方法MemberCenterRAOImpl.selectBusiRelation出现异常{}",
					w.toString());
			other.setOtherCenterResponseMsg(ResultCodeEnum.ERROR.getMsg());
			other.setOtherCenterResponseCode(ResultCodeEnum.ERROR.getCode());
		}
	...
	public OtherCenterResDTO<String> getMemberCodeById(Long memberId,
		...
		try {
			Long startTime = System.currentTimeMillis();
			LOGGER.info("根据会员ID查询会员CODE--组装查询参数开始:memberId:{},messageId:{}",
					memberId, messageId);
			ExecuteResult<String> result = memberBaseInfoService
					.getMemberCodeById(memberId);
			LOGGER.info("根据会员ID查询会员CODE--返回结果:{},,messageId:{}",
					JSONObject.toJSONString(result), messageId + "耗时:"
							+ (System.currentTimeMillis() - startTime));
			if (null != result.getResult() && result.isSuccess() == true) {
				...
				// 没有查到数据
				LOGGER.warn("根据会员ID查询会员CODE-没有查到数据 参数:memberId{},messageId:{}",
						memberId, messageId);
				other.setOtherCenterResponseCode(FacadeOtherResultCodeEnum.MEMBERCENTER_QUERY_NOT_RESULT
						.getCode());
				other.setOtherCenterResponseMsg(FacadeOtherResultCodeEnum.MEMBERCENTER_QUERY_NOT_RESULT
			...
			StringWriter w = new StringWriter();
			e.printStackTrace(new PrintWriter(w));
			LOGGER.error("调用方法MemberCenterRAOImpl.getMemberCodeById出现异常{}",
					w.toString());
			other.setOtherCenterResponseMsg(ResultCodeEnum.ERROR.getMsg());
			other.setOtherCenterResponseCode(ResultCodeEnum.ERROR.getCode());
		}
