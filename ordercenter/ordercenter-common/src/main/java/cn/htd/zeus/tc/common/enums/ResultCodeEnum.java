...
public enum ResultCodeEnum {
	...
	MARKERCENTER_LIMITED_TIME_PURCHASE_BUYCOUNT_BEYOND_PURCHASE_COUNT("10219","商品购买数量超过促销中心每单限制数量"),
	ORDER_BUYER_SELLER_SAME("10220","买家和卖家不能是同一个账号"),
	MARKERCENTER_LIMITED_TIME_PURCHASE_BUYCOUNT_BEYOND_INVENTORY("10221","商品购买数量超过促销中心剩余库存数量"),
	MARKERCENTER_LIMITED_TIME_PURCHASE_BUYCOUNT_LESS_PURCHASE_COUNT("10222","商品购买数量少于促销中心起购量"),
	ORDERCENTER_VALIDATE_LIMITED_TIME_PURCHASE_CAN_NOT_USE_COUPON("100223","限时购商品不能使用优惠券"),
