...
/**
 * 订单详情ResDTO Copyright (C), 2013-2016, 汇通达网络有限公司 FileName:
 * OrderQueryDetailResDTO.java Author: jiaop Date: 2016-8-25 下午4:47:39
 * Description: //模块目的、功能描述 History: //修改记录
 * <author> <time> <version> <desc> 修改人姓名 修改时间 版本号 描述
 */
public class OrderQueryDetailResDTO extends GenricResDTO implements Serializable {

	/**
	 *
	 */
	private static final long serialVersionUID = 5597983826531256798L;
	...
	private List<ChargeConditionInfoDTO> chargeConditionInfoList;
	...
	private String orderDeleteStatus;
	...
	public String getOrderDeleteStatus() {
		return orderDeleteStatus;
	}

	public void setOrderDeleteStatus(String orderDeleteStatus) {
		this.orderDeleteStatus = orderDeleteStatus;
	}

	/**
	 * @return the chargeConditionInfoList
	 */
	public List<ChargeConditionInfoDTO> getChargeConditionInfoList() {
		return chargeConditionInfoList;
	}

	/**
	 * @param chargeConditionInfoList
	 *            the chargeConditionInfoList to set
	 */
