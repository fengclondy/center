...
public class JDCreateOrderReqDTO implements Serializable{
	...
	//商品集合
	private List<JDCreateOrderSkuReqDTO> sku;
	...
	public List<JDCreateOrderSkuReqDTO> getSku() {
		return sku;
	}

	public void setSku(List<JDCreateOrderSkuReqDTO> sku) {
		this.sku = sku;
	}
