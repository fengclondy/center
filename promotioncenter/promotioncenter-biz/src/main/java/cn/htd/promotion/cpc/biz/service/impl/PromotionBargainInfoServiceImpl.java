...
public class PromotionBargainInfoServiceImpl implements
	...
	public PromotionBargainInfoResDTO getPromotionBargainInfoDetail(
		...
		PromotionBargainInfoDMO promotionBargainInfo = promotionBargainInfoDAO
	    ...
	    public ExecuteResult<List<PromotionBargainInfoResDTO>> updateBargainInfo(List<PromotionBargainInfoResDTO> bargainInfoList)
	        ...
	        try {
	            ...
	            if (status.equals(promotionInfoDTO.getShowStatus())) {
	                throw new PromotionCenterBusinessException(PromotionCenterCodeConst.PROMOTION_STATUS_NOT_CORRECT,
