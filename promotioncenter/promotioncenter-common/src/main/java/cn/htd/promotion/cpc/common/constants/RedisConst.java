...
public class RedisConst {
	...
	// Redis会员秒杀的使用log信息
	public static final String PROMOTION_REDIS_BUYER_TIMELIMITED_NEED_SAVE_USELOG = "B2C_MIDDLE_BUYER_TIMELIMITED_NEED_SAVE_USELOG";
	// Redis秒杀订单信息
	...
	// 粉丝投票活动记录HASH前缀
	public static final String FANS_VOTE_HASH_PREFIX = "B2C_MIDDLE_PROMOTION_VOTE_HASH";
	...
	// Redis真实拼团价
	public static final String PROMOTION_REDIS_GROUPBUYINGINFO_REAL_GROUPBUYINGPRICE = "PROMOTION_B2C_REAL_GROUPBUYINGPRICE";
	// Redis阶梯价格
	public static final String PROMOTION_REDIS_GROUPBUYINGINFO_PRICESETTING = "PROMOTION_B2C_REAL_PRICESETTING";
