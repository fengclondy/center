...
public class RedisConst {
    ...
    public static final String REDIS_BUYER_WINNING_RECORD_NEED_SAVE_LIST = "B2B_MIDDLE_BUYER_WINNING_RECORD_NEED_SAVE_LIST";
    ...
    // Redis会员秒杀log信息
    public static final String PROMOTION_REDIS_BUYER_TIMELIMITED_USELOG =
            "PROMOTION_B2B_MIDDLE_BUYER_TIMELIMITED_USELOG";
    // Redis会员秒杀的使用log信息
    public static final String PROMOTION_REDIS_BUYER_TIMELIMITED_NEED_SAVE_USELOG =
            "PROMOTION_B2B_MIDDLE_BUYER_TIMELIMITED_NEED_SAVE_USELOG";
    // Redis秒杀订单信息
    public static final String PROMOTION_REDIS_BUYER_TIMELIMITED_ORDER_INFO =
            "PROMOTION_B2B_MIDDLE_BUYER_TIMELIMITED_ORDER_INFO";
}
