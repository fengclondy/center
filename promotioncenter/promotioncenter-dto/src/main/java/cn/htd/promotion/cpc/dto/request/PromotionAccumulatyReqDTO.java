...
public class PromotionAccumulatyReqDTO extends GenricReqDTO{
    /**
	 * 
	 */
    ...
    private PromotionAwardInfoReqDTO promotionAwardInfoReqDTO;

    public PromotionAwardInfoReqDTO getPromotionAwardInfoReqDTO() {
		return promotionAwardInfoReqDTO;
	}

	public void setPromotionAwardInfoReqDTO(PromotionAwardInfoReqDTO promotionAwardInfoReqDTO) {
