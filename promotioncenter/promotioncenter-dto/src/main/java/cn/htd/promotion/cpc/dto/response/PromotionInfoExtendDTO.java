...
public class PromotionInfoExtendDTO extends PromotionInfoDTO implements
		Serializable {

	private static final long serialVersionUID = 7028616100463668532L;
	...
	public void setPromotionInfoExtend(PromotionInfoExtendDTO extendDTO){
		...
		this.deliveryType = extendDTO.getDeliveryType();
		this.paymentType = extendDTO.getPaymentType();
