...
public class PromotionInfoTestUnit {
	...
	public void savePromotionInfo() {
		try {
			...
			p1.setPromotionName("砍价活动么么哒");
			p1.setPromotionDescribe("砍价活动呵呵哒");
			...
			p1.setOfflineStartTime(DateUtil.getDateBySpecificDate("2017-08-20 12:00:00"));
			...
			p1.setPromotionSlogan("汇通达");
			p1.setIsDailyTimesLimit(1);
			p1.setDailyBuyerPartakeTimes(5);
			...
			p2.setOfflineStartTime(DateUtil.getDateBySpecificDate("2017-08-20 12:00:00"));
			...
			p2.setDailyBuyerPartakeTimes(5);
	...
	public void getPromotionInfo() {
		ExecuteResult<List<PromotionBargainInfoResDTO>> data = promotionBargainInfoService.getPromotionBargainInfoList("00001", "22171922530930");
		List<PromotionBargainInfoResDTO> list = data.getResult();
		for (PromotionBargainInfoResDTO dto : list) {
	...
	public void delPromotionInfo(){
		...
		dto.setPromotionId("22171922530930");
	...
	public void updatePromotionInfo() {
		try {
			...
			List<PromotionBargainInfoResDTO> promotionBargainInfoList = new ArrayList<PromotionBargainInfoResDTO>();
			PromotionBargainInfoResDTO p1 = new PromotionBargainInfoResDTO();
			p1.setPromotionId("22171827400931");
			...
			p1.setModifyTime(DateUtil.getDateBySpecificDate("2017-08-20 18:21:46"));
			PromotionBargainInfoResDTO p2 = new PromotionBargainInfoResDTO();
			p2.setPromotionName("砍价活动么么哒2");
			p2.setPromotionDescribe("砍价活动呵呵哒2");
			p2.setEffectiveTime(new Date());
